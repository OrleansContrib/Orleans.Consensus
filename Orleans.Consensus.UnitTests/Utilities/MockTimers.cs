namespace Orleans.Consensus.UnitTests.Utilities
{
    ...
    public class MockTimers : IList<MockTimers.TimerRegistration>
    {
        ...
        /// </returns>
        public IEnumerator<TimerRegistration> GetEnumerator()
        {
        ...
        {
            return ((IEnumerable)this.Registrations).GetEnumerator();
        }
        ...
        public void CopyTo(TimerRegistration[] array, int arrayIndex)
        {
            this.Registrations.CopyTo(array, arrayIndex);
        }
        ...
        public TimerRegistration this[int index]
        {
            get
            {
            ...
            set
            {
                this.Registrations[index] = value;
            }
        }
    }
}